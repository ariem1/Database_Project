...
-- CREATE ITEM ENTITY
CREATE TABLE ITEM(
ITEM_ID INT IDENTITY (1,1) CONSTRAINT ITEM_ITEM_ID_PK  PRIMARY KEY ,
...
INSERT INTO ITEM (ITEM_DESCRIPTION, ITEM_VALUE, ITEM_QUANTITY) VALUES ('Canned Goods','0.99','10');
INSERT INTO ITEM (ITEM_DESCRIPTION, ITEM_VALUE, ITEM_QUANTITY) VALUES ('Instant Noodles','0.99','20');
INSERT INTO ITEM (ITEM_DESCRIPTION, ITEM_VALUE, ITEM_QUANTITY) VALUES ('Blankets','10.50','10');
INSERT INTO ITEM (ITEM_DESCRIPTION, ITEM_VALUE, ITEM_QUANTITY) VALUES ('Shirts','3.50','25');
INSERT INTO ITEM (ITEM_DESCRIPTION, ITEM_VALUE, ITEM_QUANTITY) VALUES ('Hygiene Kit','1.00','30');

INSERT INTO CONTENTS VALUES ('001', (SELECT ITEM_ID FROM ITEM WHERE ITEM_DESCRIPTION = 'Canned Goods'));
INSERT INTO CONTENTS VALUES ('002', (SELECT ITEM_ID FROM ITEM WHERE ITEM_DESCRIPTION = 'Hygiene Kit'));
INSERT INTO CONTENTS VALUES ('003', (SELECT ITEM_ID FROM ITEM WHERE ITEM_DESCRIPTION = 'Blankets'));
INSERT INTO CONTENTS VALUES ('004', (SELECT ITEM_ID FROM ITEM WHERE ITEM_DESCRIPTION = 'Shirts'));
INSERT INTO CONTENTS VALUES ('005', (SELECT ITEM_ID FROM ITEM WHERE ITEM_DESCRIPTION = 'Instant Noodles'));
